...
featureList = ['Accident', 'Belts', 'Personal Injury',
               'Property Damage', 'Commercial License', 'HAZMAT',
               'Commercial Vehicle', 'Work Zone', 'State',
               'Contributed to Accident', 'Driver City', 'Driver State', 
               'DL State', 'Arrest Type']

#featureList = ['Alcohol', 'Race', 'Gender', 'Fatal']
#featureList = ['Agency', 'SubAgency', 'Description']
